...
export const site: Site = {
  name: "נסים טל",
  tagline:
    "ציורי שמן של עוברי אורח, רקדניות ושחקנים — דמויות אנונימיות הנתפסות ברגעים חולפים של היומיום.",
...
export const about: About = {
  ...
  bio: [
    "יליד ירושלים, בוגר כלכלה ויחסים בינלאומיים באוניברסיטה העברית. תואר שני בחינוך מאוניברסיטת קולומביה, ניו יורק. למדתי אמנות בבצלאל ירושלים בין השנים 1979–1983 (לא לתואר). כמו כן מילאתי מגוון תפקידים באגף התקציבים במשרד האוצר בירושלים.",
    "לאורך כל השנים עסקתי באמנות, ובניהול מוסדות תרבות ואמנות, 25 שנים ניהלתי את מוזיאוני חיפה.",
    "ב-5 השנים האחרונות אני עוסק בייעוץ אסטרטגי להקמה ולניהול מוזיאונים, במקביל אני יוצר ומציג את האמנות שלי.",
  ],
};
